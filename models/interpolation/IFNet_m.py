...
if __name__ == '__main__':
    encoder = IFNet_m()
    H, W= 1920, 1024
    flops, macs, params = get_model_profile(encoder, input_shape=(1, 6, H, W), print_profile=False, detailed=False, warm_up=10, as_string=True,)
    print("Encoder - flops:{}, macs:{}, params:{}".format(flops, macs, params))
    #macs, params = get_model_complexity_info(encoder, (6, H, W), as_strings=True, print_per_layer_stat=False)
    #print("Encoder - macs:{}, params:{}".format(macs, params))